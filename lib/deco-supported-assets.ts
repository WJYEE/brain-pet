...
export const SUPPORTED_DECO_ASSETS: SupportedDecoAsset[] = [
  ...
  { id: '공룡모자', name: '공룡모자', src: `${DECO_SUPPORTED_BASE}/공룡모자.png`, naturalWidth: 197, naturalHeight: 198 },
  { id: '금태동그라미안경', name: '금태동그라미안경', src: `${DECO_SUPPORTED_BASE}/금태동그라미안경.png`, naturalWidth: 197, naturalHeight: 198 },
  ...
  { id: '동그란유색선글라스', name: '동그란유색선글라스', src: `${DECO_SUPPORTED_BASE}/동그란유색선글라스.png`, naturalWidth: 197, naturalHeight: 198 },
  ...
  { id: '미래안대', name: '미래안대', src: `${DECO_SUPPORTED_BASE}/미래안대.png`, naturalWidth: 197, naturalHeight: 198 },
  { id: '반짝선글라스', name: '반짝선글라스', src: `${DECO_SUPPORTED_BASE}/반짝선글라스.png`, naturalWidth: 197, naturalHeight: 198 },
  { id: '방울빨간리본', name: '방울빨간리본', src: `${DECO_SUPPORTED_BASE}/방울빨간리본.png`, naturalWidth: 197, naturalHeight: 198 },
  { id: '뱅글뱅글안경', name: '뱅글뱅글안경', src: `${DECO_SUPPORTED_BASE}/뱅글뱅글안경.png`, naturalWidth: 197, naturalHeight: 198 },
  { id: '버섯모자', name: '버섯모자', src: `${DECO_SUPPORTED_BASE}/버섯모자.png`, naturalWidth: 197, naturalHeight: 198 },
  { id: '별선글라스', name: '별선글라스', src: `${DECO_SUPPORTED_BASE}/별선글라스.png`, naturalWidth: 197, naturalHeight: 198 },
  { id: '별안경', name: '별안경', src: `${DECO_SUPPORTED_BASE}/별안경.png`, naturalWidth: 197, naturalHeight: 198 },
  ...
  { id: '하트안경', name: '하트안경', src: `${DECO_SUPPORTED_BASE}/하트안경.png`, naturalWidth: 197, naturalHeight: 198 },

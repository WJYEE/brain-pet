...
const STAT_INSIGHT_BASE: Record<StatId, StatInsightBase> = {
  reaction: {
    strengths: [
      '빠른 판단이 필요한 순간에 먼저 움직이는 경향이 있어요',
      '새로운 자극에 망설임 없이 반응할 수 있어요',
      '변화가 많은 환경에 빠르게 적응하는 편이에요',
    ],
    cautions: [
      '급하게 결정하다 세부사항을 놓칠 수 있어요',
      '차분히 기다려야 하는 상황에서 답답함을 느낄 수 있어요',
    ],
    learningStyle: [
  ...
  memory: {
    strengths: [
      '한 번 접한 정보를 오래 붙잡아 두는 경향이 있어요',
      '세부적인 내용을 놓치지 않고 기억할 수 있어요',
      '쌓아온 경험을 새로운 상황에 잘 연결하는 편이에요',
    ],
    cautions: [
      '새로운 방식으로 전환할 때 시간이 조금 더 걸릴 수 있어요',
      '익숙한 방법을 고수하다 변화에 더디게 반응할 수 있어요',
    ],
    learningStyle: [
  ...
  focus: {
    strengths: [
      '한 가지 목표에 깊이 몰입하는 경향이 있어요',
      '방해 요소가 있어도 쉽게 흔들리지 않는 편이에요',
      '긴 시간 하나의 작업에 집중을 유지할 수 있어요',
    ],
    cautions: [
      '여러 일을 동시에 처리할 때 전환이 느릴 수 있어요',
      '몰입하다 주변의 다른 신호를 놓칠 수 있어요',
    ],
    learningStyle: [
  ...
  judgment: {
    strengths: [
      '상황을 빠르게 정리해서 결정을 내리는 경향이 있어요',
      '복잡한 정보 속에서도 핵심을 골라낼 수 있어요',
      '제한된 시간 안에서도 결단력을 발휘하는 편이에요',
    ],
    cautions: [
      '빠른 결정 뒤에 다시 확인하는 과정을 건너뛸 수 있어요',
      '충분히 논의되기 전에 결론부터 낼 수 있어요',
    ],
    learningStyle: [
  ...
  spatial: {
    strengths: [
      '머릿속으로 구조와 그림을 잘 그려내는 경향이 있어요',
      '복잡한 모양이나 배치를 직관적으로 파악할 수 있어요',
      '전체 구조를 입체적으로 이해하는 편이에요',
    ],
    cautions: [
      '말이나 글로 설명하는 데는 시간이 더 걸릴 수 있어요',
      '세부 절차보다 큰 그림에 먼저 집중하는 편이에요',
    ],
    learningStyle: [
  ...
  reasoning: {
    strengths: [
      '숨은 규칙과 패턴을 잘 찾아내는 경향이 있어요',
      '단서를 모아 논리적으로 결론을 이끌어낼 수 있어요',
      '복잡한 문제를 차근차근 분석하는 편이에요',
    ],
    cautions: [
      '분석이 길어지며 결정이 늦어질 수 있어요',
      '직관적인 판단보다 검증을 우선해 속도가 늦어질 수 있어요',
    ],
    learningStyle: [

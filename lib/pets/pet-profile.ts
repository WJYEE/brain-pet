...
const CHARACTER_DEFS: CharacterDef[] = [
  ...
  { id: '02_로봇', name: '로봇', primaryStat: 'judgment', secondaryStat: 'reasoning', tagline: '기계적인 연산으로 논리정연하게 결론을 내려요.' },
  { id: '03_양', name: '양', primaryStat: 'focus', secondaryStat: 'memory', tagline: '무리를 따라가며 익힌 습관을 오래오래 기억해요.' },
  { id: '04_상처도치', name: '상처도치', primaryStat: 'judgment', secondaryStat: 'focus', tagline: '위협 앞에서는 신중하게 방어 태세부터 갖춰요.' },
  { id: '05_노란병아리', name: '노란병아리', primaryStat: 'memory', secondaryStat: 'reaction', tagline: '갓 부화한 순간의 기억과 반사반응이 또렷해요.' },
  ...
  { id: '08_고래', name: '고래', primaryStat: 'spatial', secondaryStat: 'memory', tagline: '긴 이동 경로를 기억하며 넓은 바다를 항해해요.' },
  { id: '09_귀신', name: '귀신', primaryStat: 'reasoning', secondaryStat: 'memory', tagline: '과거의 기억을 단서로 삼아 추리를 즐겨요.' },
  { id: '10_벌', name: '벌', primaryStat: 'spatial', secondaryStat: 'focus', tagline: '꽃의 위치를 파악하며 집중해서 날아다녀요.' },
  { id: '11_하트덕', name: '하트덕', primaryStat: 'reaction', secondaryStat: 'memory', tagline: '재빠르게 자맥질하면서도 귀소본능은 잊지 않아요.' },
  { id: '12_홍학', name: '홍학', primaryStat: 'spatial', secondaryStat: 'reaction', tagline: '외다리로 균형을 잡으며 순간적으로 반응해요.' },
  { id: '13_나뭇잎여우', name: '나뭇잎여우', primaryStat: 'judgment', secondaryStat: 'spatial', tagline: '은신처를 고르고 지형을 파악하는 눈썰미가 있어요.' },
  { id: '14_코알라', name: '코알라', primaryStat: 'focus', secondaryStat: 'spatial', tagline: '나뭇가지 위에서 균형을 잡으며 느긋하게 집중해요.' },
  { id: '15_개미햝기', name: '개미햝기', primaryStat: 'focus', secondaryStat: 'judgment', tagline: '굴 팔 위치를 판단하며 끈질기게 집중해요.' },
  { id: '16_균형다람쥐', name: '균형다람쥐', primaryStat: 'spatial', secondaryStat: 'judgment', tagline: '저울처럼 균형을 잡으며 신중하게 판단해요.' },
  { id: '17_보라곰', name: '보라곰', primaryStat: 'memory', secondaryStat: 'judgment', tagline: '경험이 쌓여야 비로소 판단을 내리는 편이에요.' },
  { id: '18_지식토끼', name: '지식토끼', primaryStat: 'reasoning', secondaryStat: 'focus', tagline: '책을 읽으며 추론력과 몰입을 함께 다져요.' },
  { id: '19_까망외계인', name: '까망외계인', primaryStat: 'memory', secondaryStat: 'reasoning', tagline: '지식을 기억하고 추론하는 높은 지능을 가졌어요.' },
  { id: '20_찐강쥐', name: '찐강쥐', primaryStat: 'reaction', secondaryStat: 'judgment', tagline: '활발하게 반응하면서도 눈치가 빨라요.' },
  { id: '21_거북이', name: '거북이', primaryStat: 'memory', secondaryStat: 'focus', tagline: '오래 살아온 만큼 지혜롭고, 책을 읽을 땐 차분해요.' },
  { id: '22_아홀로틀', name: '아홀로틀', primaryStat: 'memory', secondaryStat: 'spatial', tagline: '서식지를 기억하고 물속 방향감각도 뛰어나요.' },
  ...
  { id: '26_푸른늑대', name: '푸른늑대', primaryStat: 'judgment', secondaryStat: 'reaction', tagline: '무리 사냥 중에도 순간적으로 판단하고 반응해요.' },
  { id: '27_겨울펭귄', name: '겨울펭귄', primaryStat: 'focus', secondaryStat: 'reasoning', tagline: '낚시에 몰입하며 전략적으로 생각해요.' },
  { id: '28_카피바라', name: '카피바라', primaryStat: 'focus', secondaryStat: 'reaction', tagline: '평온해 보여도 위협 앞에선 순식간에 움직여요.' },

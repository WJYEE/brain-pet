 ...
 * stat's registered games to play. Both pool entries are always shown; there
 * is no auto-pick or repeat-avoidance here, since the player is choosing
 * directly (see lib/game/game-registry.ts#getClassicGameKey for First Play's
 * separate always-classic path).
 */
